...
<body class="gray-bg">
	...
	<div class="modal fade" id="modal_user_addC" role="dialog" aria-labelledby="modal_user_addC" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addC" method="post" action="reserveCourse.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名：</td>
								<td><input type="text" id="name" name="name"
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="addC_form_user_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    var validator2 = $("#form_addC").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#addC_form_user_btn").click(function(){
	    	$("#form_addC").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addC").click(function(){
	    		$("#form_addC").resetForm();
	    		$('#modal_user_addC').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_addC').modal('show');
	        });
